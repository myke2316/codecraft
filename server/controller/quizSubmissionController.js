...
//     const existingQuizSubmission = await QuizSubmissionModel.findOne({
//       userId,
//     });
...
//     // Iterate over all courses, lessons, and quizzes to create quiz submissions
...
//     // Insert all quiz submissions for the user in a single document
...
//       { userId, "quizSubmissions.quizId": quizId },
//       {
//         $set: {
//           "quizSubmissions.$.selectedOption": selectedOption,
//           "quizSubmissions.$.correct": correct,
//           "quizSubmissions.$.pointsEarned": pointsEarned,
//           "quizSubmissions.$.timestamp": new Date(),
//         },
//       },
