...
import { Typography, Box, Paper, CircularProgress, Card } from "@mui/material";
import { useTheme } from "@mui/material/styles";

const TeacherCourseActiveChart = ({ activeUsersPerCourse }) => {
      ...
      return (
        ...
        >
          ...
          <Typography
            variant="body2"
            color="primary"
          >{`Active Users: ${payload[0].value}`}</Typography>
        </Paper>
      );
    }
    return null;
...
export default TeacherCourseActiveChart;
