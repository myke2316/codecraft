      ...
      <div className="htmlandcss">
        <div className="htmlcourse">
          ...
          <div className="samplecode">
            <div className="containersamplecode">
...
<html lang="en">
    ...
    <body>
        ...
        <div className="htmldesc">
          ...
          <div className="samplecode">
            <div className="containersamplecodecss">
...
<html lang="en">
    ...
    <body>
      ...
      <div className="javascript">
        ...
        <div className="javascriptsample">
        <div className="containersamplecodejs">
...
<html lang="en">
    ...
    <body>
      ...
      <div className="javascript">
        ...
        <div className="javascriptsample">
        <div className="containersamplecodephp">
